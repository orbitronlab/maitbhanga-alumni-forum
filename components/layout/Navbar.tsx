...
import {
  ...
  Shield, Bell, Heart, GraduationCap
} from 'lucide-react';
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={cn(
                  ...
                  link.isAccent
                    ? 'bg-accent text-accent-foreground hover:bg-accent-600 shadow-gold font-semibold'
                    : pathname === link.href
            ...
            {session ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-primary/5 dark:hover:bg-white/5 transition-all"
                >
