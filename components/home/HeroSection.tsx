...
import { ArrowRight, Play, Users, Award, MapPin } from 'lucide-react';
      ...
      <div className="page-container relative z-10 pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-white text-sm font-medium">
                Established 1950 · Sandwip, Chattogram
              </span>
            </motion.div>
            ...
            >
              Welcome to{' '}
              <span className="text-accent">Maitbhanga</span>{' '}
              Alumni Forum
            </motion.h1>
            ...
            >
              Reconnect with thousands of proud alumni. Celebrate shared memories,
              participate in events, support school development, and build
              lasting bonds with your alma mater.
            </motion.p>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { icon: Users, label: 'Total Alumni', value: '5,000+', color: 'bg-blue-500/20 text-blue-300' },
                    { icon: Award, label: 'Life Members', value: '250+', color: 'bg-amber-500/20 text-amber-300' },
                    { icon: MapPin, label: 'Countries', value: '15+', color: 'bg-green-500/20 text-green-300' },
                    { icon: Play, label: 'Events This Year', value: '8', color: 'bg-purple-500/20 text-purple-300' },
                  ].map((item, i) => (
                    <motion.div
                      key={item.label}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-white font-bold font-heading">Maitbhanga High School</p>
                      <p className="text-gray-300 text-sm">Est. 1950 · Sandwip, Chattogram</p>
                    </div>
                  ...
                  <div className="mt-4 flex gap-2">
                    <span className="badge bg-green-500/20 text-green-300 text-xs">Active</span>
                    <span className="badge bg-accent/20 text-accent text-xs">75+ Years Legacy</span>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            >
              <p className="text-primary-900 font-bold text-sm">🎓 Join Today</p>
            </motion.div>
            <motion.div
              animate={{ y: [5, -5, 5] }}
            ...
            >
              <p className="text-white font-bold text-sm">❤️ 75+ Year Legacy</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
